...
def num_check(question, num_type, exit_code=None):
    """Checks user enters an integer / float that is more
    than zero (or the optional exit code)"""
    ...
    while True:
        ...
        try:
            # change the response to an integer and check that it is more than zero
